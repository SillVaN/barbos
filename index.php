                    ...
                    <div class="block-content">
                        <ul id="block-tovar-grid">
                            ...
                            <?php
                               ...
                               $result = mysql_query("SELECT * FROM products ORDER BY $sorting",$link);
                               ...
                               if (mysql_num_rows($result) > 0){
                                  ...
                                  <li>
                                    ...
                                    <img src="<?php echo "img/uploads-img/".$row['image']?>">
                                    </div>

                                    <p class="style-title-grid"><?php echo $row["nazv"]?></p>


                                    <p class="style-discription-grid">
                                        <span class="mr-3"><i>размер:</i><?php echo $row["razm"]?>см</span>
                                        <span><i>вес:</i><?php echo $row["ves"]?>.'г'</span>
                                    </p>


                                    <p class="style-discription-grid">
                                        <span class="mr-3"><i>материал:</i></span><?php echo $row["mtrl"]?></span>
                                        <span><i>состав:</i><?php echo $row["consist"] ?></span>
                                    </p>
                                    ...
                                    <div class="price-and-basket">
                                        <a class="add-cart-style-grid" tid="<?php echo $row['Kod_tov']">
                                        <i class="icon icon-basket"></i></a>
                                        <p class="style-price-grid"><span><?php echo $row['price']?></span> грн</p>
                                    </div>
                                  </li>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="block-parameter">
                         ...
                         <ul class="block-parameter__item">
                            <li class="mb-2"><a href="index.php?sort=price-asc">От дешёвых к дорогим</a></li>
