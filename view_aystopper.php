<?php
	...
	switch ($go){
		...
		case "news":
			$query_aystopper= " WHERE new = '1'";
			$name_aystopper= "Новинки товаров";
			break;
		
		case "leaders":
			$query_aystopper= " WHERE leader = '1'";
			$name_aystopper= "Лидеры продаж";
			break;
		    
		case "sale":
			$query_aystopper= " WHERE sale = '1'";
                    ...
                    <div class="block-content">
                        <ul id="block-tovar-grid">
                            ...
                            <?php
                                  ...
                                  $num = 6;
								  $page = (int) $_GET['page'];
								  $count = mysql_query("SELECT COUNT(*) FROM products $query_aystopper",$link);
                               ...
                               $result = mysql_query("SELECT * FROM products $query_aystopper ORDER BY $sorting",$link);
                ...
                <div class="col-lg-3">
                    ...
                    <div class="block-parameter">
                         ...
                         <ul class="block-parameter__item">
                            <li class="mb-2"><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc">От дешёвых к дорогим</a></li>
