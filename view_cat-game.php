    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Наши товары</h1>
                    <p class="text-center mt-3">Самое лучшее для наших девчонок и мальчишек!!!</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-9">
                    <div class="block-content">
                        <ul id="block-tovar-grid">
                            ...
                            <?php
                               ...
                               $result = mysql_query("SELECT * FROM products WHERE products.kategory = 'Игрушки' ORDER BY $sorting",$link);
                ...
                <div class="col-lg-3">
                    ...
                    <div class="block-parameter">
                         ...
                         <ul class="block-parameter__item">
                            <li class="mb-2"><a href="view_cat-game.php?sort=price-asc">От дешёвых к дорогим</a></li>
                            <li><a href="view_cat-game.php?sort=price-desc">От дорогих к дешёвым</a></li>
                         </ul>
                    </div>
                </div>
            </div>
