    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Наши товары</h1>
                    <p class="text-center mt-3">Самое полезное и вкусное у нас!!!</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-9">
                    <div class="block-content">
                        <ul id="block-tovar-grid">
                            ...
                            <?php
                               ...
                               $result = mysql_query("SELECT * FROM products WHERE products.kategory = 'Питание' ORDER BY $sorting",$link);
                ...
                <div class="col-lg-3">
                    ...
                    <div class="block-parameter">
                         ...
                         <ul class="block-parameter__item">
                            <li class="mb-2"><a href="view_cat-prod.php?sort=price-asc">От дешёвых к дорогим</a></li>
                            <li><a href="view_cat-prod.php?sort=price-desc">От дорогих к дешёвым</a></li>
                         </ul>
                    </div>
                </div>
            </div>
